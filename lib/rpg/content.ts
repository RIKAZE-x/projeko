...
export const aren: Character = {
  id:'aren-vey-l', name:'Auren Veyl', race:'Human', level:18, xp:7320,
  attributes:{STR:42,VIT:38,MAG:17,SPD:31,INT:24,SKL:35},
  profession:{id:'blade-warden',name:'Blade Warden',level:12,xp:2840,rank:'C',branches:['Knight','Warden','Spellblade']},
  skills:[skills[0],skills[1]], equipment:[items[0]], gold:4820, reputation:64,
};

export const lyra: Character = {
  id:'lyra-valen', name:'Lyra Valen', race:'Aelari', level:17, xp:6980,
  attributes:{STR:12,VIT:24,MAG:51,SPD:29,INT:48,SKL:39},
  profession:{id:'astral-mage',name:'Astral Mage',level:14,xp:3410,rank:'C',branches:['Arcanist','Oracle','Astral Mage']},
  skills:[skills[2]], equipment:[items[1]], gold:5210, reputation:71,
};

export const kael: Character = {
  id:'kael-ardyn', name:'Kael Ardyn', race:'Human', level:16, xp:6030,
  attributes:{STR:28,VIT:29,MAG:19,SPD:48,INT:34,SKL:44},
  profession:{id:'night-ranger',name:'Night Ranger',level:13,xp:3120,rank:'C',branches:['Ranger','Assassin','Beast Hunter']},
  skills:[skills[3]], equipment:[items[2]], gold:3910, reputation:52,
};
...
export const world = {
  continents:7, seas:9, majorPowers:12, autonomousRegions:31, majorCities:48, mediumCities:117, importantVillages:'700+', registeredDungeons:3800,
  zones:['Central Heartland','Aelari Wilds','Dhurak Mountains','Varkhan Steppe','Dravari Volcanic Belt','Nymari Seas','Sylphid Skylands','Myr Desert','Noctari Underworld','Astraen Reach','Construct Ruins','Southern Wilds'],
  capitals:['Valerion','Prime','Arclight','Ironwall','Goldmere'],
};
